...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class WorkmanagerLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>hilt</b> with <b>androidx.hilt:hilt-work</b> coordinates and
         * with version reference <b>hiltNavigationCompose</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getHilt() {
            return create("workmanager.hilt");
        }

        /**
         * Group of libraries at <b>workmanager.runtime</b>
         */
        public WorkmanagerRuntimeLibraryAccessors getRuntime() {
            return laccForWorkmanagerRuntimeLibraryAccessors;
        }

    }

    public static class WorkmanagerRuntimeLibraryAccessors extends SubDependencyFactory {
         ...
         */
        public Provider<MinimalExternalModuleDependency> getKtx() {
            return create("workmanager.runtime.ktx");
        }
