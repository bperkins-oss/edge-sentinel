...
import com.bp22intel.edgesentinel.analysis.LocationProfile;
...
import com.bp22intel.edgesentinel.di.AppModule_ProvideAlertFeedbackDaoFactory;
...
public final class DaggerEdgeSentinelApp_HiltComponents_SingletonC {
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          return (T) new AlertDetailViewModel(viewModelCImpl.savedStateHandle, singletonCImpl.alertRepositoryImplProvider.get(), singletonCImpl.threatAnalystProvider.get(), singletonCImpl.alertFeedbackDao());

          case 1: // com.bp22intel.edgesentinel.ui.alerts.AlertsViewModel 
          return (T) new AlertsViewModel(singletonCImpl.alertRepositoryImplProvider.get(), singletonCImpl.alertExporterProvider.get());
          ...
          return (T) new DashboardViewModel(singletonCImpl.alertRepositoryImplProvider.get(), singletonCImpl.cellRepositoryImplProvider.get(), singletonCImpl.scanRepositoryImplProvider.get(), new DemoDataGenerator(), singletonCImpl.provideCellInfoCollectorProvider.get(), singletonCImpl.sensorFusionEngineProvider.get(), singletonCImpl.overallThreatDashboardProvider.get(), singletonCImpl.threatAnalystProvider.get(), singletonCImpl.motionDetectorProvider.get(), singletonCImpl.alertExporterProvider.get());
  ...
  private static final class ServiceCImpl extends EdgeSentinelApp_HiltComponents.ServiceC {
    ...
    private MonitoringService injectMonitoringService2(MonitoringService instance) {
      ...
      MonitoringService_MembersInjector.injectFalsePositiveFilter(instance, singletonCImpl.falsePositiveFilterProvider.get());
      ...
      MonitoringService_MembersInjector.injectSensorFusionEngine(instance, singletonCImpl.sensorFusionEngineProvider.get());
      MonitoringService_MembersInjector.injectMotionDetector(instance, singletonCImpl.motionDetectorProvider.get());
      MonitoringService_MembersInjector.injectWifiMonitor(instance, singletonCImpl.wifiMonitorProvider.get());
      MonitoringService_MembersInjector.injectWifiThreatDetector(instance, singletonCImpl.wifiThreatDetectorProvider.get());
      MonitoringService_MembersInjector.injectTrustedNetworkDao(instance, singletonCImpl.provideTrustedNetworkDaoProvider.get());
      MonitoringService_MembersInjector.injectBleTrackingDetector(instance, singletonCImpl.bleTrackingDetectorProvider.get());
      MonitoringService_MembersInjector.injectBleAlertManager(instance, singletonCImpl.bleAlertManagerProvider.get());
      MonitoringService_MembersInjector.injectDnsIntegrityChecker(instance, singletonCImpl.dnsIntegrityCheckerProvider.get());
      MonitoringService_MembersInjector.injectTlsIntegrityChecker(instance, singletonCImpl.tlsIntegrityCheckerProvider.get());
      MonitoringService_MembersInjector.injectCaptivePortalDetector(instance, singletonCImpl.captivePortalDetectorProvider.get());
      MonitoringService_MembersInjector.injectVpnMonitor(instance, singletonCImpl.vpnMonitorProvider.get());
      return instance;
    }
  }
  ...
  private static final class SingletonCImpl extends EdgeSentinelApp_HiltComponents.SingletonC {
    ...
    private Provider<LocationProfile> locationProfileProvider;

    private Provider<FalsePositiveFilter> falsePositiveFilterProvider;

    private Provider<ThreatAnalyst> threatAnalystProvider;

    private Provider<AlertExporter> alertExporterProvider;
    ...
    private Provider<MotionDetector> motionDetectorProvider;
    ...
    private AlertFeedbackDao alertFeedbackDao() {
      return AppModule_ProvideAlertFeedbackDaoFactory.provideAlertFeedbackDao(provideDatabaseProvider.get());
    }
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.towerDatabaseManagerProvider = DoubleCheck.provider(new SwitchingProvider<TowerDatabaseManager>(singletonCImpl, 15));
      this.locationProfileProvider = DoubleCheck.provider(new SwitchingProvider<LocationProfile>(singletonCImpl, 18));
      this.falsePositiveFilterProvider = DoubleCheck.provider(new SwitchingProvider<FalsePositiveFilter>(singletonCImpl, 17));
      this.threatAnalystProvider = DoubleCheck.provider(new SwitchingProvider<ThreatAnalyst>(singletonCImpl, 16));
      this.alertExporterProvider = DoubleCheck.provider(new SwitchingProvider<AlertExporter>(singletonCImpl, 19));
      this.bleTrackerIdentifierProvider = DoubleCheck.provider(new SwitchingProvider<BleTrackerIdentifier>(singletonCImpl, 22));
      this.bleDeviceTrackerProvider = DoubleCheck.provider(new SwitchingProvider<BleDeviceTracker>(singletonCImpl, 21));
      this.bleAlertManagerProvider = DoubleCheck.provider(new SwitchingProvider<BleAlertManager>(singletonCImpl, 23));
      this.bleTrackingDetectorProvider = DoubleCheck.provider(new SwitchingProvider<BleTrackingDetector>(singletonCImpl, 20));
      this.calibrationServiceProvider = DoubleCheck.provider(new SwitchingProvider<CalibrationService>(singletonCImpl, 24));
      this.threatNarratorProvider = DoubleCheck.provider(new SwitchingProvider<ThreatNarrator>(singletonCImpl, 26));
      this.sensorFusionEngineProvider = DoubleCheck.provider(new SwitchingProvider<SensorFusionEngine>(singletonCImpl, 25));
      this.overallThreatDashboardProvider = DoubleCheck.provider(new SwitchingProvider<OverallThreatDashboard>(singletonCImpl, 27));
      this.motionDetectorProvider = DoubleCheck.provider(new SwitchingProvider<MotionDetector>(singletonCImpl, 28));
      this.vpnMonitorProvider = DoubleCheck.provider(new SwitchingProvider<VpnMonitor>(singletonCImpl, 29));
      this.dnsIntegrityCheckerProvider = DoubleCheck.provider(new SwitchingProvider<DnsIntegrityChecker>(singletonCImpl, 30));
      this.tlsIntegrityCheckerProvider = DoubleCheck.provider(new SwitchingProvider<TlsIntegrityChecker>(singletonCImpl, 31));
      this.captivePortalDetectorProvider = DoubleCheck.provider(new SwitchingProvider<CaptivePortalDetector>(singletonCImpl, 32));
      this.provideDataStoreProvider = DoubleCheck.provider(new SwitchingProvider<DataStore<Preferences>>(singletonCImpl, 33));
      this.threatGeolocationProvider = DoubleCheck.provider(new SwitchingProvider<ThreatGeolocation>(singletonCImpl, 34));
      this.wifiMonitorProvider = DoubleCheck.provider(new SwitchingProvider<WifiMonitor>(singletonCImpl, 35));
      this.provideTrustedNetworkDaoProvider = DoubleCheck.provider(new SwitchingProvider<TrustedNetworkDao>(singletonCImpl, 37));
      this.wifiThreatDetectorProvider = DoubleCheck.provider(new SwitchingProvider<WifiThreatDetector>(singletonCImpl, 36));
      this.wifiEnvironmentAnalyzerProvider = DoubleCheck.provider(new SwitchingProvider<WifiEnvironmentAnalyzer>(singletonCImpl, 38));
      this.wifiProbeProtectorProvider = DoubleCheck.provider(new SwitchingProvider<WifiProbeProtector>(singletonCImpl, 39));
    }
    ...
    private EdgeSentinelApp injectEdgeSentinelApp2(EdgeSentinelApp instance) {
      ...
      EdgeSentinelApp_MembersInjector.injectTowerDatabaseManager(instance, towerDatabaseManagerProvider.get());
      EdgeSentinelApp_MembersInjector.injectAlertDao(instance, alertDao());
      return instance;
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 15: // com.bp22intel.edgesentinel.detection.tower.TowerDatabaseManager 
          ...
          case 16: // com.bp22intel.edgesentinel.analysis.ThreatAnalyst 
          return (T) new ThreatAnalyst(singletonCImpl.falsePositiveFilterProvider.get());

          case 17: // com.bp22intel.edgesentinel.analysis.FalsePositiveFilter 
          return (T) new FalsePositiveFilter(singletonCImpl.alertFeedbackDao(), singletonCImpl.locationProfileProvider.get());

          case 18: // com.bp22intel.edgesentinel.analysis.LocationProfile 
          return (T) new LocationProfile(singletonCImpl.cellDao());

          case 19: // com.bp22intel.edgesentinel.export.AlertExporter 
          return (T) new AlertExporter(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule));

          case 20: // com.bp22intel.edgesentinel.detection.bluetooth.BleTrackingDetector 
          ...
          case 21: // com.bp22intel.edgesentinel.detection.bluetooth.BleDeviceTracker 
          return (T) new BleDeviceTracker(singletonCImpl.bleDeviceDao(), singletonCImpl.bleTrackerIdentifierProvider.get());

          case 22: // com.bp22intel.edgesentinel.detection.bluetooth.BleTrackerIdentifier 
          return (T) new BleTrackerIdentifier();

          case 23: // com.bp22intel.edgesentinel.detection.bluetooth.BleAlertManager 
          return (T) new BleAlertManager(singletonCImpl.bleDeviceTrackerProvider.get());

          case 24: // com.bp22intel.edgesentinel.calibration.CalibrationService 
          ...
          case 25: // com.bp22intel.edgesentinel.fusion.SensorFusionEngine 
          return (T) new SensorFusionEngine(singletonCImpl.threatNarratorProvider.get());

          case 26: // com.bp22intel.edgesentinel.fusion.ThreatNarrator 
          return (T) new ThreatNarrator();

          case 27: // com.bp22intel.edgesentinel.fusion.OverallThreatDashboard 
          ...
          case 28: // com.bp22intel.edgesentinel.sensor.MotionDetector 
          return (T) new MotionDetector(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule));

          case 29: // com.bp22intel.edgesentinel.detection.network.VpnMonitor 
          ...
          case 30: // com.bp22intel.edgesentinel.detection.network.DnsIntegrityChecker 
          return (T) new DnsIntegrityChecker();

          case 31: // com.bp22intel.edgesentinel.detection.network.TlsIntegrityChecker 
          ...
          case 32: // com.bp22intel.edgesentinel.detection.network.CaptivePortalDetector 
          return (T) new CaptivePortalDetector();

          case 33: // androidx.datastore.core.DataStore<androidx.datastore.preferences.core.Preferences> 
          ...
          case 34: // com.bp22intel.edgesentinel.detection.geo.ThreatGeolocation 
          return (T) new ThreatGeolocation();

          case 35: // com.bp22intel.edgesentinel.detection.wifi.WifiMonitor 
          ...
          case 36: // com.bp22intel.edgesentinel.detection.wifi.WifiThreatDetector 
          return (T) new WifiThreatDetector(singletonCImpl.provideTrustedNetworkDaoProvider.get());

          case 37: // com.bp22intel.edgesentinel.data.local.dao.TrustedNetworkDao 
          return (T) AppModule_ProvideTrustedNetworkDaoFactory.provideTrustedNetworkDao(singletonCImpl.provideDatabaseProvider.get());

          case 38: // com.bp22intel.edgesentinel.detection.wifi.WifiEnvironmentAnalyzer 
          return (T) new WifiEnvironmentAnalyzer();

          case 39: // com.bp22intel.edgesentinel.detection.wifi.WifiProbeProtector 
